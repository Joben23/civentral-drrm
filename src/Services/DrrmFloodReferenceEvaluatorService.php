...
/**
 * Shared read-only evaluator for the single controlled 15-feature flood draft.
 *
 * Policy-specific admin and citizen services project this internal result into
 * their own response shapes. No caller-controlled geometry or classification
 * enters this evaluator.
 */
final class DrrmFloodReferenceEvaluatorService
{
