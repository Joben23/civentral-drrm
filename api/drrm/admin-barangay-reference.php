...
require_once __DIR__ . '/../../src/Services/DrrmAdminBarangayReferenceService.php';
...
try {
    ...
    $featureCollection = (new DrrmAdminBarangayReferenceService(
    ...
    if ($json === false) {
        throw new RuntimeException('The admin barangay reference could not be encoded.');
    }
    ...
    drrmApiRespond(false, null, 'Unable to load the admin barangay reference.', 502);
}
