...
try {
    ...
    $service = new DrrmDraftLandslidePreviewService(
    ...
    if ($json === false) {
        throw new RuntimeException('The draft landslide GeoJSON response could not be encoded.');
    }
    ...
    drrmApiRespond(false, null, 'Unable to load the draft landslide preview.', 502);
}
