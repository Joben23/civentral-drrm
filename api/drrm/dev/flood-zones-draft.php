...
try {
    ...
    $service = new DrrmDraftFloodPreviewService(
    ...
    if ($json === false) {
        throw new RuntimeException('The draft flood GeoJSON response could not be encoded.');
    }
    ...
    drrmApiRespond(false, null, 'Unable to load the draft flood preview.', 502);
}
