...
try {
    ...
    $service = new DrrmDraftEvacuationCenterPreviewService(
    ...
    if ($json === false) {
        throw new RuntimeException('The draft evacuation-center response could not be encoded.');
    }
    ...
    drrmApiRespond(false, null, 'Unable to load the draft evacuation-center preview.', 502);
}
