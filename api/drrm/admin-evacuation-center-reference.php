...
require_once __DIR__ . '/../../src/Services/DrrmAdminEvacuationCenterReferenceService.php';
...
try {
    ...
    $service = new DrrmAdminEvacuationCenterReferenceService(
    ...
    if ($json === false) {
        throw new RuntimeException('The admin center reference could not be encoded.');
    }
    ...
    drrmApiRespond(false, null, 'Unable to load the admin center reference.', 502);
}
